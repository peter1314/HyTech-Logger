...
public class ScanItemPresenter extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final CodeInputDialog joinLineDialog = new CodeInputDialog(ScanItemPresenter.this, "Enter Code", "", "") {
    ...
    private String getBranch() { return GlobalVariables.currentType.BRANCH; }

    private Intent getDataExistsIntent() { return new Intent(ScanItemPresenter.this, ViewItemPresenter.class); }

    private Intent getDataNewIntent() { return new Intent(ScanItemPresenter.this, NewItemEntryPresenter.class); }
}
